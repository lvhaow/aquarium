            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Animal Category All</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Animal Category All Data</h4>
                                    ...
                                    @foreach ($animalcategory as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('delete.animal.category', $item->id) }}" class="btn btn-danger sm"
