                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="gallery_name" value=" {{ $gallery->gallery_name }} "
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="gallery_title" value="{{ $gallery->gallery_title }}"
                                            class="form-control" type="text" id="example-text-input">
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Gallery Description
                                    </label>
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="gallery_description">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg"
                                            src=" {{ asset($gallery->gallery_image) }} " alt="Card image cap">
                                    </div>
                                </div>
                                <!-- end row -->
